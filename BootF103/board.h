...
// ==== General ====
#define BOARD_NAME          "MotorCtrl01"
#define APP_NAME            "Boot TofStandF103"
...
#define SYS_TIM_CLK             (Clk.GetTimInputFreq(TIM2))
